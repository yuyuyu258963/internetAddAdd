...
export default class GoCaptcha extends Component<any,any> {
    static defaultProps = {
    ...
    render() {
        ...
        const RenderDotItem = () => {
            ...
            return dots.map((dot:any) => (<Fragment key={dot.index}>
    ...
    // ===========
    static getDerivedStateFromProps(nextProps: { value: any; imageBase64: any; thumbBase64: any; }, prevState: { imageBase64Code: any; thumbBase64Code: any; }) {
        const res:any = {}
        let count = 0
        if (!nextProps.value){
            res['dots'] = []
     ...
     * @param el
     */
    calcLocationLeft = (el: { offsetLeft: any; offsetParent: any; }) => {
     ...
     * @param el
     */
    calcLocationTop = (el: { offsetTop: any; offsetParent: any; }) => {
